...
import { Cryptocurrency, formatCurrency, formatNumber, formatPercentage, getPercentageClass } from "@/services/crypto-api";
...
const CryptoListItem: React.FC<CryptoListItemProps> = ({ crypto, onClick }) => {
  return (
